...
Bullet::SphereRigidBody::SphereRigidBody(float rad, Vec3<float> const& pos, float mass, GameObject* futurAssignedGO)
{
	this->name = "SphereRigidBody";
	/* Create Shape */
	btSphereShape* shape = new btSphereShape((btScalar)rad);
