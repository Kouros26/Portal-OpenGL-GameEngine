...
static bool CreatingScene = false;
static std::string* newFileName = new std::string("");

static void ShowCreateScreen(bool* p_open)
{
    ImGui::Begin("Creating File", &CreatingScene);
    ...
    if (ImGui::Button("Save"))
    {
        ...
        app->NewScene(*newFileName);
        CreatingScene = false;
    }
    ImGui::End();
}

static void ShowSaveScreen(bool* p_open)
{
    ImGui::Begin("Saving File", &SavingScene);
    ImGui::Text("New File Name : ");
    ImGui::SameLine();
    ImGui::InputText("##", newFileName);
    if (ImGui::Button("Save"))
...
static void ShowExampleMenuFile()
{
    ...
    else if (ImGui::BeginMenu("Open"))
    {
        ...
        for (const auto& entry : std::filesystem::recursive_directory_iterator(path))
        {
            ...
            if (ImGui::MenuItem(pathName.c_str()))
            {
                app->GetSaveFileName() = pathName;
            }
        }
        ImGui::EndMenu();
    }
